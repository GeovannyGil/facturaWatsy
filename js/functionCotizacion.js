...
const tableCotizaciones = document.getElementById("bodyTableCotizaciones");
...
const btnGuardar = document.getElementById("btnGenerarCotizacion");
const btnImprimir = document.getElementById("btnImprimirCotizacion");
let subTotal = 0;
...
const verificarCotizacionesLocalStorage = () => {
  ...
  /*   tableCotizaciones.innerHTML = "";
    ...
    cotizaciones.forEach((detalle) => {
      ...
      tableCotizaciones.appendChild(fila);
    }) */
};
